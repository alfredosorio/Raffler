...
User.create!([
  ...
  { email: 'j.depp@outlook.com',                        password: 'password' },
  { email: 'hanky_panky@hollwoodstudios.com',           password: 'password' },
  { email: 'snoopdogg311@gangstermail.com',             password: 'password' },
  { email: 'tony_montana@sosa.co',                      password: 'password' },
  { email: 'willy_shakespeare25@heavenlymail.com',      password: 'password' },
  { email: 'harry_potter@hogwartsmail.edu',             password: 'password' }
])

Profile.create!([
  { id: 999, user_id: 999, username: 'admin', first_name: 'Admin',  last_name: 'Raffler' },

  { user_id: 1, username: 'johnny_depp_32',     first_name: 'Johnny',   last_name: 'Depp' },
  { user_id: 2, username: 'hanky_panky',        first_name: 'Tom',      last_name: 'Hanks' },
  { user_id: 3, username: 'snoopaloop311',      first_name: 'Snoop',    last_name: 'Dogg' },
  { user_id: 4, username: 'tony_montana',       first_name: 'Tony',     last_name: 'Montana' },
  { user_id: 5, username: 'willy_shakespeare',  first_name: 'William',  last_name: 'Shakespeare' },
  { user_id: 6, username: 'harry_potterson16',  first_name: 'Harry',    last_name: 'Potter' }
])

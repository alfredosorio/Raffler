...
class SellersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seller" do
    assert_difference('Seller.count') do
      post sellers_url, params: { seller: { item_id: @seller.item_id, seller_rating: @seller.seller_rating, user_id: @seller.user_id } }
    end
  ...
  test "should update seller" do
    patch seller_url(@seller), params: { seller: { item_id: @seller.item_id, seller_rating: @seller.seller_rating, user_id: @seller.user_id } }
